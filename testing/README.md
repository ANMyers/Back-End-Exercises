[Animal Testing](https://github.com/nashville-software-school/bangazon-llc/blob/master/orientation/exercises/10_TEST_ANIMALS.md) file used to run unit tests.
